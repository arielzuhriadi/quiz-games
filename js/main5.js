...
const isiSoal = 'Apa yang masuk ke air tapi tidak pernah basah?';
const clueSoal = `Selalu mengikuti kita ke mana pun.
Benda ini tidak memiliki wujud fisik.
Bisa dilihat tapi tidak bisa disentuh.`;
const jawabanSoal = 'bayangan';
