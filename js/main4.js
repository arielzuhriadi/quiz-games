...
const isiSoal = 'Apa yang selalu terbang tapi nggak pernah meninggalkan tempat?';
const clueSoal = `Ini selalu ada di hidup kita.
Tidak bisa dipegang atau ditahan.
Kadang cepat, kadang lambat, tergantung situasi.`;
const jawabanSoal = 'waktu';
